...
<header>
  <nav class="main-navbar">
    ...
    <label class="nav-logo">RentNest</label>

    <ul class="nav-menu">
      <li><a class="active" href="${pageContext.request.contextPath}/public/index.jsp">Home</a></li>
      <li><a href="${pageContext.request.contextPath}/public//property-list.jsp">Properties</a></li>
      ...
      <c:if test="${not empty sessionScope.user}">
        ...
        <li class="mobile-profile">
          <a href="${pageContext.request.contextPath}/user/bookings.jsp">My Bookings</a>
        </li>
        <li class="mobile-profile">
          <a href="${pageContext.request.contextPath}/user/wishlist.jsp">Wishlist</a>
        </li>
        <li class="mobile-profile">
          <a href="${pageContext.request.contextPath}/LogoutController" class="logout">Logout</a>
        </li>
      </c:if>
    </ul>
    ...
    <c:if test="${empty sessionScope.user}">
      <div class="auth-area">
        <a href="${pageContext.request.contextPath}/auth/login.jsp">Login</a>
        <a href="${pageContext.request.contextPath}/auth/register.jsp" class="register-link">Register</a>
      </div>
    </c:if>
    ...
    <c:if test="${not empty sessionScope.user}">
      <div class="profile-area">
        ...
        <label for="profile-toggle" class="profile-btn">
          <img src="${pageContext.request.contextPath}/images/images.jpg" alt="User" />
        ...
        <div class="profile-dropdown">
          ...
          <a href="${pageContext.request.contextPath}/user/bookings.jsp">
            <i class="fa fa-calendar"></i> My Bookings
          </a>
          <a href="${pageContext.request.contextPath}/user/wishlist.jsp">
            <i class="fa fa-heart"></i> Wishlist
          </a>
          <a href="${pageContext.request.contextPath}/LogoutController" class="logout">
