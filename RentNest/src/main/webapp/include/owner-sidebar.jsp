<div class="navcontainer">
	<nav class="nav">
		<div class="nav-upper-options">
			<a href="owner-dashboard.jsp" class="nav-option"> <i
				class="fa fa-th-large nav-img"></i><span>Dashboard</span>
			</a> <a href="owner-properties.jsp" class="nav-option"> <i
				class="fa fa-building-o nav-img"></i><span>My Properties</span>
			</a> <a href="owner-add-property.jsp" class="nav-option"> <i
				class="fa fa-plus nav-img"></i><span>Add Property</span>
			</a> <a href="owner-bookings.jsp" class="nav-option active-option"> <i
				class="fa fa-calendar nav-img"></i><span>Booking Requests</span>
			</a> <a href="owner-payments.jsp" class="nav-option"> <i
				class="fa fa-money nav-img"></i><span>Earnings</span>
			</a>
		</div>

		<div class="nav-lower-options">
			<a href="owner-profile.jsp" class="nav-option"> <i
