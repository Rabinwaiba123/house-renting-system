  ...
  <body>
   ...
   <jsp:include page="/include/navbar.jsp" />
    ...
    <section class="hero">
      ...
      <p class="subtitle">
        Helping you find the perfect home easily and securely. We believe
        everyone deserves a space that feels like home.
      </p>
    ...
    <section class="purpose">
      ...
      <div class="text">
        ...
        <p>
          Founded in 2024, RentNest was created with a simple idea — finding a
          home should be an exciting and meaningful experience, not a stressful
          one.
        </p>

        <p>
          We aim to simplify the process by offering verified listings,
          transparent communication, and a user-friendly platform that puts
          people first.
        </p>

        <p>
          Our vision is to become a trusted space where individuals can
    ...
    <section class="cards">
      <div class="card">
        <h3>Our Mission</h3>
        <p>
          To empower users with a seamless and secure property search
          experience.
        </p>
      </div>
