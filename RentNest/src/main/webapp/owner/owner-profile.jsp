              ...
              <div class="settings-grid">
                <div class="setting-card">
                  ...
                  <div class="setting-text">
                    ...
                    <p>
                      Update your password to keep your owner account secure.
                    </p>
                  </div>
                </div>
                ...
                <div class="setting-card">
                  ...
                  <div class="setting-text">
                    ...
                    <p>
                      Manage booking alerts, payment updates, and property
                      notifications.
                    </p>
                  </div>
                </div>
                ...
                <div class="setting-card">
                  ...
                  <div class="setting-text">
                    <h3>Security</h3>
                    <p>
                      Review login activity and keep your property account
                      protected.
                    </p>
                  </div>
                </div>
                ...
                <table class="users-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>2026-04-18</td>
                      <td>
                        <span class="status-badge blocked">Cancelled</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
