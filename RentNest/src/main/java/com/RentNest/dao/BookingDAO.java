 ...
 * BookingDAO
 * 
 * Responsibilities: - Handles all database operations related to property
 * bookings. - Adds new booking records when a tenant books a property. -
 * Retrieves booking details for both admin and tenant pages. - Uses JOIN
 * queries to display user name and property details instead of only IDs. - Uses
 * soft delete by updating is_deleted instead of permanently removing booking
 * data.
 *
 * Important concepts used: - JDBC Connection, PreparedStatement and ResultSet -
 * DAO layer separation from Servlet and Service layer - SQL JOIN for combining
 * bookings, users and properties - Soft delete for safer record management
 */
public class BookingDAO {

	/**
	 * Inserts a new booking into the bookings table. This method is used when a
	 * tenant books a property. PreparedStatement is used to safely pass booking
	 * values into the SQL query.
	 */
